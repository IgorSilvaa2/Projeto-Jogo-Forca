...
/////////////////////// FUNCAO CRIAR HISTORICO //////////////////////////////

void criarHistorico()
{
    ifstream ficheiroTeste("historico.txt");

    if (!ficheiroTeste.is_open())
    {
        ficheiroTeste.close();

        ofstream novoFicheiro("historico.txt");
        ...
        {
            cout << "\nNao foi possivel criar o ficheiro historico.txt\n";
        }
    }
    else
    {
...
void mostrarRanking()
{
    ...
    {
        if (!getline(ficheiro, dificuldade, ';'))
            break;

        if (!getline(ficheiro, palavra, ';'))
            break;

        if (!getline(ficheiro, pontosTexto, ';'))
            break;

        if (!getline(ficheiro, resultado))
            break;
    ...
    const string &resultado)
{
    ...
    if (!ficheiro.is_open())
    {
        cout << "\nErro: nao foi possivel abrir historico.txt.\n";
        return;
    }
    ...
    string dificuldade)
{
    ...
    cout << "A sua palavra e um "
         << categoria
         << " e tem "
         << palavraSecreta->size()
         << " letras\n";

    cout << "Sua pontuacao e: "
         << pontos
         << "\n";
    ...
    while (true)
    {
        ...
        if (ganhou)
        {
            ...
            // Se for false, o programa vai encerrar.
        ...
        ////////////////////// PEDIR LETRA OU PALAVRA ///////////////////////

        string tentativa;

        cout << "\nDigite uma letra";
        cout << " ou, se souber, a palavra completa: ";
        ...
        {
            tentativa[i] = toupper(
                static_cast<unsigned char>(tentativa[i])
            );
        }
        ...
        if (tentativa.empty())
        {
            ...
            cout << "Digite uma letra ou a palavra completa.\n";
        ...
        if (tentativa.size() == 1)
        {
            ...
            if (!isalpha(
                static_cast<unsigned char>(letra)
            ))
            {
                cout << "\nEntrada invalida!\n";
        ...
        else
        {
            ...
            ////////////////// TENTATIVA DA PALAVRA //////////////////////////

            if (tentativa == *palavraSecreta)
            {
                letrasCertas = *palavraSecreta;
            ...
            else
            {
                ...
                cout << "A tentativa nao corresponde a palavra secreta.\n";
            }
        }
...
bool menu_Dificuldade(const string &nome)
{
    ...
    // Retorna false para o menu principal
    ...
    do
    {
        ...
        switch (escolha)
        {
            ...
            case 1:
            {
                ...
                bool continuar = menu_Dificuldade(nome);
            ...
            case 2:
            {
                ...
                cout << "         REGRAS DO JOGO DA FORCA\n";

                cout << "=========================================\n\n";

                cout << "1. OBJETIVO:\n";

                cout << "   Adivinhar a palavra secreta antes que o\n";

                cout << "   boneco seja totalmente desenhado.\n\n";

                cout << "2. COMO JOGAR:\n";

                cout << "   - Introduza uma letra de cada vez.\n";

                cout << "   - Se a letra existir, ela sera revelada.\n";

                cout << "   - Se errar, uma parte do corpo vai para a forca.\n";

                cout << "   - Tambem pode escrever a palavra completa.\n\n";

                cout << "3. ENTRADAS:\n";

                cout << "   - Pode escrever letras maiusculas ou minusculas.\n";

                cout << "   - Numeros e simbolos nao sao aceites.\n";

                cout << "   - Uma letra repetida nao conta como novo erro.\n\n";

                cout << "4. PONTUACAO:\n";

                cout << "   - Comeca com 6 pontos.\n";

                cout << "   - Letra correta: +1 ponto.\n";

                cout << "   - Letra errada: -1 ponto.\n";

                cout << "   - Palavra completa correta: +5 pontos.\n";

                cout << "   - Palavra completa errada: -2 pontos.\n\n";

                cout << "5. FIM DE JOGO:\n";

                cout << "   - VITORIA: Se descobrir todas as letras.\n";

                cout << "   - DERROTA: Se atingir o limite de 6 erros.\n\n";
